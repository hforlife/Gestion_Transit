...
<?php $__env->startSection('content'); ?>
    ...
    <div style="text-align: center; margin-bottom: 30px;">
        ...
        <p style="color: #666; font-size: 11px;">Document généré le <?php echo e(now()->format('d/m/Y à H:i')); ?></p>
    </div>
    ...
    <div style="margin-bottom: 30px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 5px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                ...
                <p style="margin: 5px 0 0 0; opacity: 0.9;"><?php echo e($colis->numero_bl); ?></p>
            </div>
            ...
            <div>
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;"><?php echo e($colis->numero_bl); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; background: #f5f5f5;"><strong>Type de colis</strong></td>
                        <td style="padding: 8px;"><?php echo e($colis->typeColis?->nom ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; background: #f5f5f5;"><strong>Description</strong></td>
                        <td style="padding: 8px;"><?php echo e($colis->description ?? 'Aucune description'); ?></td>
                    </tr>
                    <tr>
            ...
            <div>
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;"><?php echo e($colis->dossierTransit?->client?->nom ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; background: #f5f5f5;"><strong>Agent responsable</strong></td>
                        <td style="padding: 8px;"><?php echo e($colis->agent?->name ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; background: #f5f5f5;"><strong>Port d'entrée</strong></td>
                        <td style="padding: 8px;"><?php echo e($colis->port?->nom ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; background: #f5f5f5;"><strong>Référence dossier</strong></td>
                        <td style="padding: 8px;"><?php echo e($colis->dossierTransit?->reference ?? 'N/A'); ?></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div style="margin-bottom: 30px; page-break-inside: avoid;">
        ...
        <div style="background: #f8fafc; padding: 15px; border-radius: 5px;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                <div>
                    <span class="badge badge-<?php echo e($colis->status_colis_douane === 'SORTI' ? 'success' : ($colis->status_colis_douane !== 'EN_ATTENTE' ? 'warning' : 'secondary')); ?>">
                        Statut: <?php echo e(match($colis->status_colis_douane) {
                            'EN_ATTENTE' => 'En attente',
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 15px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;"><?php echo e($colis->num_t1 ?? 'Non fourni'); ?></td>
                    </tr>
                    <tr>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;"><?php echo e($colis->declaration_reference ?? 'Non fournie'); ?></td>
                    </tr>
                </table>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td style="padding: 8px; background: #f0f0f0; width: 40%;"><strong>Date d'entrée</strong></td>
                        <td style="padding: 8px;">
                            <?php echo e($colis->date_entree_douane ? \Carbon\Carbon::parse($colis->date_entree_douane)->format('d/m/Y') : 'Non renseignée'); ?>
                    ...
                    <tr>
                        <td style="padding: 8px; background: #f0f0f0;"><strong>Date de sortie</strong></td>
                        <td style="padding: 8px;">
                            <?php echo e($colis->date_sortie_douane ? \Carbon\Carbon::parse($colis->date_sortie_douane)->format('d/m/Y') : 'Non renseignée'); ?>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($colis->date_entree_douane && $colis->date_sortie_douane): ?>
                                <?php echo e(\Carbon\Carbon::parse($colis->date_entree_douane)->diffInDays(\Carbon\Carbon::parse($colis->date_sortie_douane))); ?> jours
                            <?php elseif($colis->date_entree_douane): ?>
                                En cours depuis <?php echo e(\Carbon\Carbon::parse($colis->date_entree_douane)->diffInDays(now())); ?> jours
                            <?php else: ?>
                                -
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
        ...
        <div style="background: #f8fafc; padding: 15px; border-radius: 5px;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                <div>
                    <span class="badge badge-<?php echo e($colis->etat_expertise === 'EFFECTUEE' ? 'success' : 'warning'); ?>">
                        <?php echo e($colis->etat_expertise === 'EFFECTUEE' ? 'Expertise effectuée' : 'Expertise en attente'); ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px;">
                ...
                <div style="border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
                    ...
                    <p style="margin: 5px 0;"><strong>N°:</strong> <?php echo e($colis->num_pvc ?? 'Non fourni'); ?></p>
                    <p style="margin: 5px 0;">
                        <strong>État:</strong> 
                        <span class="badge badge-<?php echo e($colis->etat_pvc === 'PAYE' ? 'success' : ($colis->etat_pvc === 'RECU' ? 'warning' : 'danger')); ?>">
                            <?php echo e($colis->etat_pvc ?? 'NON_RECU'); ?>
                ...
                <div style="border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
                    ...
                    <p style="margin: 5px 0;"><strong>N°:</strong> <?php echo e($colis->num_ae ?? 'Non fourni'); ?></p>
                    <p style="margin: 5px 0;">
                        <strong>État:</strong> 
                        <span class="badge badge-<?php echo e($colis->etat_ae === 'VALIDE' ? 'success' : 'danger'); ?>">
                            <?php echo e($colis->etat_ae ?? 'NON_VALIDE'); ?>
                ...
                <div style="border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
                    ...
                    <p style="margin: 5px 0;"><strong>N°:</strong> <?php echo e($colis->num_cmc ?? 'Non fourni'); ?></p>
                    <p style="margin: 5px 0;">
                        <strong>État:</strong> 
                        <span class="badge badge-<?php echo e($colis->etat_cmc === 'RECU' ? 'success' : 'danger'); ?>">
                            <?php echo e($colis->etat_cmc ?? 'NON_RECU'); ?>
            ...
            <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                <div>
                    <span class="badge badge-<?php echo e($colis->status_colis_livraison === 'LIVRE' ? 'success' : 'warning'); ?>">
                        <?php echo e($colis->status_colis_livraison === 'LIVRE' ? 'Livré' : 'En attente de livraison'); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;">
                            <?php echo e($colis->date_livraison ? \Carbon\Carbon::parse($colis->date_livraison)->format('d/m/Y H:i') : 'Non renseignée'); ?>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;"><?php echo e($colis->commentaires_cloture ?? 'Aucun commentaire'); ?></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($colis->dossierTransit): ?>
    <div style="margin-bottom: 30px; page-break-inside: avoid;">
        <h3 style="color: #667eea; margin: 0 0 15px 0; font-size: 18px; border-bottom: 2px solid #667eea; padding-bottom: 5px;">
            📁 DOSSIER DE TRANSIT
        </h3>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;"><?php echo e($colis->dossierTransit->reference); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; background: #f0f0f0;"><strong>Nom du dossier</strong></td>
                        <td style="padding: 8px;"><?php echo e($colis->dossierTransit->nom); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; background: #f0f0f0;"><strong>Type de dossier</strong></td>
                        <td style="padding: 8px;"><?php echo e($colis->dossierTransit->typeDossier?->nom ?? 'N/A'); ?></td>
                    </tr>
                </table>
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px;">
                            <?php echo e($colis->dossierTransit->date_depot ? \Carbon\Carbon::parse($colis->dossierTransit->date_depot)->format('d/m/Y') : 'Non renseignée'); ?>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px;">
                            <span class="badge badge-<?php echo e($colis->dossierTransit->status === 'CLOTURE' ? 'success' : ($colis->dossierTransit->status === 'EN_COURS' ? 'warning' : 'primary')); ?>">
                                <?php echo e($colis->dossierTransit->status); ?>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 8px; border-bottom: 1px solid #ddd;">
                        <?php echo e($colis->updated_at ? \Carbon\Carbon::parse($colis->updated_at)->format('d/m/Y') : '-'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($colis->status === 'TERMINE'): ?>
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #ddd;">Clôture du dossier</td>
                    <td style="padding: 8px; border-bottom: 1px solid #ddd;">
                        <?php echo e($colis->updated_at ? \Carbon\Carbon::parse($colis->updated_at)->format('d/m/Y H:i') : '-'); ?>
...
<div style="margin-top: 50px; page-break-inside: avoid;">
    ...
    <div style="margin-top: 30px; font-size: 10px; color: #999; text-align: center;">
        ...
        <p>Document généré le <?php echo e(now()->format('d/m/Y à H:i:s')); ?></p>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pdf.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gestion_Transit\resources\views/pdf/recap-complet.blade.php ENDPATH**/ ?>